...
export const useConversationLogPageStore = create<ConversationLog>(
  (set, get) => ({
    ...
    columns: [
      ...
      { name: 'EOS', key: 'eos_latency_ms', visible: true },
      { name: 'Time Taken', key: 'time_taken', visible: false },
      { name: 'Tokens', key: 'total_token', visible: true },
      { name: 'Language', key: 'language', visible: true },
